...
namespace LunchOrderManagement.Migrations
{
    ...
    [Migration("20210306183912_Init_DB")]
            ...
            modelBuilder.Entity("LunchOrderManagement.Entities.Class", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ClassId = "29d075b9-d345-44c9-b2b5-5fc416a6fef1",
                            ClassName = "C1020K1"
                        },
                        new
                        {
                            ClassId = "49da7c2d-251e-43ff-83eb-027ee657098d",
                            ClassName = "C0920G1"
                        },
                        new
                        {
                            ClassId = "49e24f8d-5cf6-4727-a40d-42220be7d6b4",
                            ClassName = "C0221H1"
                        });
                });
            ...
            modelBuilder.Entity("LunchOrderManagement.Entities.Food", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            FoodId = "23fbe179-d9bc-4c11-9720-e0501da87da2",
                            IsActive = true,
                            Name = "Cơm gà xối mỡ",
                            Price = 20000m
                        },
                        new
                        {
                            FoodId = "0a584914-9cc5-475a-b723-1c1c2a074237",
                            IsActive = true,
                            Name = "Cơm sườn",
                            Price = 15000m
                        },
                        new
                        {
                            FoodId = "a12cd2e6-f3a9-4470-b8ef-32f80ada738e",
                            IsActive = true,
                            Name = "Cơm sườn non",
                            Price = 25000m
                        });
